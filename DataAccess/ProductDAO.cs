...
namespace DataAccess
{
    public class ProductDAO : BaseDAL
    {
        ...
        public IEnumerable<Product> GetMemberList()
        {
            ...
            try
            {
                ...
                if (addPro == null)
                {
                    string SQLInsert = "Insert Product " +
                        "values(@CategoryId,@ProductName,@Weight,@UnitPrice,@UnitslnStock)";
                    var parameters = new List<SqlParameter>();
                    parameters.Add(dataProvider.CreateParameter("@CategoryId", 100, product.CategoryId, DbType.String));
